<%@ Page Title="" Language="C#" MasterPageFile="~/Utilizator/Principal.Master" AutoEventWireup="true" CodeBehind="Laptopuri.aspx.cs" Inherits="Licenta_prototip_2.Utilizator.Laptopuri" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="container py-5">
         <h1 class="text-center">Laptopuri</h1>
         <div class="row row-cols-1 row-cols-md-3 g-4 py-5">

             <div class="col">
                 <div class="card">
                     <img src="../Bootstrap/images/lpt1.png" class="card-img-top" />
                     <div class="card-body">
             ...
             <div class="col">
                 <div class="card">
                     <img src="../Bootstrap/images/lpt2.jpg" class="card-img-top" />
                     <div class="card-body">
             ...
             <div class="col">
                 <div class="card">
                     <img src="../Bootstrap/images/lpt3.jpeg" class="card-img-top" />
                     <div class="card-body">
             ...
             <div class="col">
                 <div class="card">
                     <img src="../Bootstrap/images/lpt4.jpg" class="card-img-top" />
                     <div class="card-body">
             ...
             <div class="col">
                 <div class="card">
                     <img src="../Bootstrap/images/lpt5.jpg" class="card-img-top" />
                     <div class="card-body">
             ...
             <div class="col">
                 <div class="card">
                     <img src="../Bootstrap/images/lpt6.jpg" class="card-img-top" />
                     <div class="card-body">
